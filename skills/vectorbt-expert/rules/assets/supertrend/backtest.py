...
# --- Strategy: Supertrend ---
st_line, st_direction = ta.supertrend(
...
print('\n' + '=' * 60)
print(
    f'  Supertrend({ST_PERIOD}, {ST_MULTIPLIER}) Backtest - {SYMBOL} ({EXCHANGE} {INTERVAL})'
)
print('=' * 60)
print(pf.stats())
...
print(
    f'* Total Return: {pf.total_return() * 100:.2f}% (intraday, squared off at 15:15)'
)
