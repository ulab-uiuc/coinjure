...
class ControlBar(Horizontal):
    ...
    Human operators click buttons; the agent uses ``pred-market-cli trade`` CLI.
...
class TradingMonitorApp(App[None]):
    ...
    # Monitor is read-only for keyboard — buttons and pred-market-cli trade CLI control engine.
    BINDINGS = [
    ...
    def _refresh_title(self) -> None:
        ...
        self.sub_title = (
            '⏸  PAUSED — click ▶ Resume or: pred-market-cli trade resume'
            if paused
            else '▶  Running — click ⏸ Pause or: pred-market-cli trade pause'
        )
        self.sub_title = (
    ...
    async def on_button_pressed(self, event: Button.Pressed) -> None:
        """Handle control-bar button clicks (same effect as pred-market-cli trade CLI)."""
...
class SocketTradingMonitorApp(App[None]):
    ...
    Start with:  pred-market-cli monitor
    """
    ...
    def __init__(self, socket_path: Path | None = None) -> None:
        from pred_market_cli.cli.control import SOCKET_PATH
    ...
    async def _poll_state(self) -> None:
        ...
        from pred_market_cli.cli.control import send_command
        ...
        self.sub_title = (
            '⏸  Engine PAUSED — click ▶ Resume or: pred-market-cli trade resume'
            if self._paused
            else '▶  Engine running — click ⏸ Pause or: pred-market-cli trade pause'
        )
