...
def make_bar(
    close, volume=1_000_000, date='2026-01-15', open_=None, high=None, low=None
):
...
def make_correction_history(
    peak=100.0, decline_pct=5.0, down_days=5, base_volume=1_000_000
):
    """
