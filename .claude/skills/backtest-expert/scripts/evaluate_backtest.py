...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=float,
        required=True,
        help='Average winning trade in percent',
    )
    parser.add_argument(
        '--avg-loss-pct',
        type=float,
    ...
    parser.add_argument(
        ...
        type=float,
        required=True,
        help='Maximum drawdown in percent',
    )
    parser.add_argument(
        '--years-tested',
        type=int,
        required=True,
        help='Number of years in backtest period',
    )
    parser.add_argument(
        '--num-parameters',
        type=int,
        required=True,
        help='Number of tunable parameters in strategy',
    )
    parser.add_argument(
        '--slippage-tested',
        action='store_true',
        help='Whether slippage/friction was modeled',
    )
    parser.add_argument(
