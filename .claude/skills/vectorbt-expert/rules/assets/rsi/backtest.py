...
print(
    f'  -> Worst peak-to-trough decline. RSI strategies tend to have lower drawdowns.'
)
print(f'* Win Rate: {pf.trades.win_rate() * 100:.1f}%')
print(
    f'  -> RSI strategies typically have higher win rates (50-65%) but smaller gains.'
)
print(
...
print(
    f"  -> {'Sufficient' if pf.trades.count() >= 30 else 'Too few trades - results unreliable'}"
)
