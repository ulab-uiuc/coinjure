...
def _build_signal(
    ...
    if score >= 80:
        return f'BROAD PARTICIPATION: {uptrend_count}/{total_sectors} sectors uptrending{spread_pct}'
    elif score >= 60:
        return (
            f'HEALTHY: {uptrend_count}/{total_sectors} sectors uptrending{spread_pct}'
        )
    elif score >= 40:
        return (
            f'MODERATE: {uptrend_count}/{total_sectors} sectors uptrending{spread_pct}'
        )
    elif score >= 20:
