...
class TestBatchStockMetricsFieldMerge:
    ...
    def test_pe_only_triggers_rsi_fallback(self):
        ...
        with (
            ...
            patch.object(
                scanner, '_batch_stock_metrics_yfinance', return_value=yf_results
            ),
        ):
    ...
    def test_stats_stock_context_set(self):
        ...
        with patch.object(
            scanner, '_batch_stock_metrics_fmp', return_value=fmp_stock_results
        ):
    ...
    def test_stats_etf_context_set(self):
        ...
        with patch.object(
            scanner, '_batch_etf_volume_ratios_fmp', return_value=fmp_etf_results
        ):
