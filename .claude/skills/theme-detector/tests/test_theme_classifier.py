...
class TestClassifyThemes:
    ...
    def test_cross_sector_bullish(self):
        ranked = [
            _make_ranked_industry(
                'Ind A', 1, 10.0, 'bullish', 'Tech', rank_direction='bullish'
            ),
            _make_ranked_industry(
                'Ind B', 2, 8.0, 'bullish', 'Tech', rank_direction='bullish'
            ),
            _make_ranked_industry(
                'Ind C', 3, 5.0, 'bullish', 'Health', rank_direction='bullish'
            ),
        ]
    ...
    def test_cross_sector_bearish_with_rank_direction(self):
        ...
        ranked = [
            _make_ranked_industry(
                'Ind A', 100, 3.0, 'bullish', 'Tech', rank_direction='bearish'
            ),
            _make_ranked_industry(
                'Ind B', 101, 2.0, 'bullish', 'Tech', rank_direction='bearish'
            ),
            _make_ranked_industry(
                'Ind C', 102, 1.0, 'bullish', 'Health', rank_direction='bearish'
            ),
        ]
        config = self._make_config()
