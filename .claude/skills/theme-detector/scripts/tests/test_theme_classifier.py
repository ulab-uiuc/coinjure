...
def _make_ranked_industry(
    name, weighted_return, momentum_score, direction, rank, sector=None
):
...
class TestCrossSectorThemes:
    ...
    def test_ai_theme_detected_with_two_matches(self):
        ...
        ranked = [
            _make_ranked_industry(
                'Semiconductor', 15.0, 82.0, 'bullish', 1, 'Technology'
            ),
            _make_ranked_industry(
                'Software - Application', 12.0, 75.0, 'bullish', 2, 'Technology'
            ),
            _make_ranked_industry(
    ...
    def test_all_three_matches(self):
        ...
        ranked = [
            ...
            _make_ranked_industry(
                'IT Services', 10.0, 70.0, 'bullish', 3, 'Technology'
            ),
        ]
        themes = classify_themes(ranked, SAMPLE_THEMES_CONFIG)
    ...
    def test_theme_direction_bearish(self):
        ...
        ranked = [
            _make_ranked_industry(
                'Semiconductor', -15.0, 82.0, 'bearish', 1, 'Technology'
            ),
            _make_ranked_industry(
    ...
    def test_theme_direction_mixed(self):
        ...
        ranked = [
            ...
            _make_ranked_industry(
                'Software - Application', -5.0, 50.0, 'bearish', 5, 'Technology'
            ),
...
class TestVerticalThemes:
    ...
    def test_vertical_theme_detected_with_three_same_sector(self):
        ...
        ranked = [
            _make_ranked_industry(
                'Semiconductor', 20.0, 90.0, 'bullish', 1, 'Technology'
            ),
            _make_ranked_industry(
                'Software - Application', 18.0, 85.0, 'bullish', 2, 'Technology'
            ),
            _make_ranked_industry(
                'IT Services', 15.0, 82.0, 'bullish', 3, 'Technology'
            ),
            _make_ranked_industry(
        ...
        themes = classify_themes(ranked, SAMPLE_THEMES_CONFIG)
        vertical_names = [
            t['theme_name'] for t in themes if 'Sector' in t['theme_name']
        ]
    ...
    def test_vertical_bearish_bottom_sector(self):
        ...
        ranked = [
            ...
            _make_ranked_industry(
                'IT Services', -10.0, 70.0, 'bearish', 3, 'Technology'
            ),
            _make_ranked_industry(
                'Software - Application', -15.0, 82.0, 'bearish', 4, 'Technology'
            ),
            _make_ranked_industry(
                'Semiconductor', -20.0, 90.0, 'bearish', 5, 'Technology'
            ),
        ]
        themes = classify_themes(ranked, SAMPLE_THEMES_CONFIG)
...
class TestTopNFiltering:
    ...
    def test_middle_industries_excluded_with_small_top_n(self):
        ...
        ranked.append(
            _make_ranked_industry(
                'Semiconductor', 20.0, 95.0, 'bullish', 1, 'Technology'
            )
        )
        ranked.append(
            _make_ranked_industry(
                'Software - Application', 18.0, 90.0, 'bullish', 2, 'Technology'
            )
        )
        ranked.append(
        ...
        ranked.append(
            _make_ranked_industry(
                'Banks - Diversified', 15.0, 85.0, 'bullish', 4, 'Financial'
            )
        )
        ranked.append(
        ...
        for i in range(6, 96):
            if i == 50:
                ...
                ranked.append(
                    _make_ranked_industry(
                        'Steel', -0.1, 49.0, 'bearish', i, 'Basic Materials'
                    )
                )
            elif i == 52:
                ranked.append(
        ...
        ranked.append(
            _make_ranked_industry(
                'Utilities - Renewable', -20.0, 5.0, 'bearish', 98, 'Utilities'
            )
        )
        ranked.append(
            _make_ranked_industry(
                'Retail_A', -21.0, 4.0, 'bearish', 99, 'Consumer Cyclical'
            )
        )
        ranked.append(
            _make_ranked_industry(
                'Retail_B', -22.0, 3.0, 'bearish', 100, 'Consumer Cyclical'
            )
        )
    ...
    def test_vertical_theme_only_in_top_bottom(self):
        ...
        ranked.append(
            _make_ranked_industry(
                'Banks - Regional', 18.0, 90.0, 'bullish', 2, 'Financial'
            )
        )
        ranked.append(
        ...
        for i, name in enumerate(
            ['Semiconductor', 'Software - Application', 'IT Services'], 4
        ):
            ranked.append(
        ...
        ranked.append(
            _make_ranked_industry(
                'Retail_A', -18.0, 8.0, 'bearish', 8, 'Consumer Cyclical'
            )
        )
        ranked.append(
            _make_ranked_industry(
                'Retail_B', -20.0, 5.0, 'bearish', 9, 'Consumer Cyclical'
            )
        )
