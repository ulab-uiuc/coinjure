...
def main():
    ...
    parser.add_argument(
        ...
        type=int,
        default=2,
        help='Days back for earnings (default: 2)',
    )
    parser.add_argument(
        '--min-market-cap',
        type=float,
    ...
    parser.add_argument(
        '--min-gap', type=float, default=0, help='Minimum gap %% (default: 0)'
    )
    parser.add_argument(
        '--max-api-calls',
        type=int,
    ...
    parser.add_argument(
        '--top', type=int, default=20, help='Top results to include (default: 20)'
    )
    parser.add_argument(
        '--output-dir',
        type=str,
    ...
    if estimated_calls > remaining_calls:
        ...
        print(
            f'Trimmed to {len(candidates)} candidates (by market cap).', file=sys.stderr
        )
    else:
        print(
    ...
    json_path = os.path.join(
        args.output_dir, f'earnings_trade_analyzer_{timestamp}.json'
    )
