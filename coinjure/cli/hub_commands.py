"""Hub CLI group — shared Market Data Hub (exchange data fan-out).

Commands
--------
  hub start   — start the shared exchange poller
  hub status  — show subscriber count, uptime, events forwarded
  hub stop    — stop the running hub
"""
...
@click.group()
def hub() -> None:
    """Shared Market Data Hub (exchange data fan-out)."""
