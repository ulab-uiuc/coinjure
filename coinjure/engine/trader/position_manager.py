...
class PositionManager:
    ...
    def get_unrealized_pnl(self, ticker: Ticker, market_data: DataManager) -> Decimal:
    ...
    def get_pnl(self, ticker: Ticker, market_data: DataManager) -> Decimal:
    ...
    def get_total_unrealized_pnl(self, market_data: DataManager) -> Decimal:
    ...
    def get_total_pnl(self, market_data: DataManager) -> Decimal:
    ...
    def get_portfolio_value(self, market_data: DataManager) -> dict[str, Decimal]:
