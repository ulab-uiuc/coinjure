...
from coinjure.events import NewsEvent
from coinjure.market.live.google_news_data_source import (
    DEFAULT_QUERIES,
...
class TestScrapeGoogleNews:
    ...
    @patch(
        'coinjure.market.live.google_news_data_source._make_request',
