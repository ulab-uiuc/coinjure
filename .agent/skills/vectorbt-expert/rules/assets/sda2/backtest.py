...
atr2 = pd.Series(
    tl.ATR(high.values, low.values, close.values, timeperiod=2), index=close.index
)
...
print(
    f'* Sharpe Ratio: {pf.sharpe_ratio():.2f} (return per unit of risk, >1 decent, >2 excellent)'
)
...
print(
    f'* Win Rate: {pf.trades.win_rate() * 100:.1f}% - SDA2 is trend-following, expect 35-45%'
)
print(
