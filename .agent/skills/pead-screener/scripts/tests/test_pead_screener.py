...
class TestBreakoutCalculator:
    def test_breakout_detected(self):
        ...
        weekly = [
            ...
            _make_weekly_candle(
                '2026-02-09', 2026, 7, 102, 103, 97, 98, volume=4_000_000
            ),  # Red
            _make_weekly_candle(
                '2026-02-02', 2026, 6, 95, 102, 94, 101, volume=5_000_000
            ),  # Green
        ]
        red_candle = {
            'high': 103,
    ...
    def test_no_breakout(self):
        ...
        weekly = [
            _make_weekly_candle(
                '2026-02-16', 2026, 8, 100, 102, 99, 101, volume=4_000_000
            ),
        ]
        red_candle = {
            'high': 103,
    ...
    def test_volume_confirmation(self):
        ...
        weekly = [
            ...
            _make_weekly_candle(
                '2026-02-09', 2026, 7, 102, 103, 97, 98, volume=3_000_000
            ),
            _make_weekly_candle(
                '2026-02-02', 2026, 6, 95, 102, 94, 101, volume=3_000_000
            ),
            _make_weekly_candle(
                '2026-01-26', 2026, 5, 90, 96, 89, 95, volume=3_000_000
            ),
            _make_weekly_candle(
                '2026-01-19', 2026, 4, 88, 91, 87, 90, volume=3_000_000
            ),
        ]
        red_candle = {
            'high': 103,
    ...
    def _build_candles_for_stage(self, stage: str) -> tuple:
        ...
        if stage == 'MONITORING':
            ...
            candles = [
                ...
                _make_weekly_candle(
                    '2026-02-02', 2026, 6, 95, 101, 94, 100
                ),  # Earnings week
            ]
        else:
            candles = []
...
class TestValidateInputJson:
    ...
    def test_missing_required_field(self, caplog):
        ...
        assert any(
            'missing required fields' in r.message.lower() for r in caplog.records
        )
...
class TestAnalyzeStock:
    ...
    def test_basic_analysis(self):
        ...
        prices = _make_daily_prices(
            30, start_date='2026-01-19', base_price=100.0, daily_change=0.5
        )
