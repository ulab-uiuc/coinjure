...
class TestGroupDivergence:
    ...
    def test_trend_dissenter_flags(self):
        ...
        assert (
            result['cyclical_divergence']['trend_dissenters'][0]['sector']
            == 'Financial'
        )
    ...
    def test_divergence_penalty(self):
        ...
        summary = make_full_sector_summary(
            ratios={'Technology': 0.50, 'Consumer Cyclical': 0.10}
        )
        sector_map = {s['Sector']: s for s in summary}
        result = _calculate_group_divergence(sector_map)
        assert result['divergence_flag'] is True
    ...
    def test_outlier_detection(self):
        ...
        sector_map = {
            ...
            'Consumer Cyclical': make_sector_summary_row(
                'Consumer Cyclical', ratio=0.10
            ),
            'Communication Services': make_sector_summary_row(
                'Communication Services', ratio=0.30
            ),
...
class TestWarningPenalties:
    ...
    def test_penalty_clamped_at_zero(self):
        ...
        result = calculate_composite_score(
            scores,
            warning_flags={'late_cycle': True, 'high_spread': True, 'divergence': True},
        )
...
class TestHistoricalConfidence:
    ...
    def test_confidence_in_full_calculation(self):
        ...
        assert result['confidence']['confidence_level'] in (
            'Low',
            'Very Low',
            'Moderate',
        )
