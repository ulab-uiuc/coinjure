...
REQUIRED_SKILLS = {
    'market_breadth': {
        'prefix': 'market_breadth_',
        'role': 'Market participation breadth',
    },
    'uptrend_analysis': {
        'prefix': 'uptrend_analysis_',
        'role': 'Sector uptrend ratios',
    },
    'market_top': {
        'prefix': 'market_top_',
        'role': 'Distribution / top risk (defense)',
    },
    'macro_regime': {
        'prefix': 'macro_regime_',
        'role': 'Macro regime transition (1-2Y structure)',
    },
    'ftd_detector': {
        'prefix': 'ftd_detector_',
        'role': 'Bottom confirmation / re-entry (offense)',
    },
}
