...
def generate_allocation(
    ...
    base = dict(
        ZONE_BASE_ALLOCATIONS.get(zone, ZONE_BASE_ALLOCATIONS['Moderate Conviction'])
    )
    ...
    pattern_adj = PATTERN_ADJUSTMENTS.get(
        pattern, PATTERN_ADJUSTMENTS['wait_and_observe']
    )
